...
@include('frontend.templates.header')
    ...
    <!--shopping cart area start --><br><br><br><br><br>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th class="product_remove" width="10%"></th>
                                    <th class="product_thumb" width="20%">Image</th>
                            ...
                            <tbody>
                            	...
                            	<?php foreach ($cart_detail as $key => $value) { ?>
									<tr>
	                                   <td class="product_remove"><a href="{{ url('frontend/cart/destroy_from_cart', $value->id) }}"><i class="fa fa-trash-o"></i>Delete</a></td>
	                                    <td class="product_thumb"><a href="#"><img src="{{ asset(Storage::url('img/product')) }}/{{ $value->product->product_image }}" alt="" width="30%"></a></td>
                                ...
                                <form method="POST" action="{{ url('frontend/checkout/create') }}">
                                  ...
                                  <div class="coupon_inner">
                                     <div class="cart_subtotal">
                                         <p>Subtotal</p>
                                         <p class="cart_amount">Rp. {{ number_format(isset($cart->total_price) ? $cart->total_price : 0, 2, ',', '.') }}</p>
                                     </div>
                                     ...
                                     <input type="hidden" name="total_price" value="{{ isset($cart->total_price) ? $cart->total_price : 0 }}">
                                     <div class="cart_subtotal">
                                         <p>Total</p>
                                         <?php $grand_total = (isset($cart->total_price) ? $cart->total_price : 0) - $total_voucher ?>
