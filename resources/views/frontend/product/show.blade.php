...
<!--product details start--><br><br><br><br>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product-details-tab">
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <a href="#">
                            <img id="zoom1" src="{{ asset(Storage::url('img/product')) }}/{{ $product->product_image }}" data-zoom-image="{{ asset(Storage::url('img/product')) }}/{{ $product->product_image }}" alt="big-1" width="400">
                        </a>
                    </div>
