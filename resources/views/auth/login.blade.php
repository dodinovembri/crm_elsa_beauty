        ...
        <div class="row justify-content-center">
          <div class="col-md-7 mb-5"><br><br>
            ...
            <form action="{{ route('login') }}" method="POST" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Login" class="btn btn-black rounded-0 py-3 px-4">
                  <a href="{{ url('frontend/register/index') }}"><input type="button" value="Register" class="btn btn-black rounded-0 py-3 px-4"></a>
                </div>
              </div>
