...
class ServiceController extends Controller
{
    ...
    */
    ...
    public $file_storage    = "public/img/service";
    ...
    */
    public $base    = "admin";
    public $index   = "admin/service/index";
    public $create  = "admin/service/create";
    public $store   = "admin/service/store";
    public $show    = "admin/service/show";
    public $edit    = "admin/service/edit";
    public $update  = "admin/service/update";
    public $destroy = "admin/service/destroy";
    ...
    public function index()
    {
        ...
        $data['table_data'] = ServiceModel::all();
    ...
    public function edit($id)
    {
        ...
        $data['field_first'] = $this->field_first;
        $data['field_break'] = $this->field_break;
        $data['table_content'] = ServiceModel::find($id);
    ...
    public function destroy($id)
    {
        ...
        $findtodelete = ServiceModel::find($id);
        $findtodelete->delete();
